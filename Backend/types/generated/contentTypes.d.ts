...
export interface ApiCampusCampus extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Long: Schema.Attribute.Float & Schema.Attribute.Required;
    main_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    manager: Schema.Attribute.Relation<'manyToOne', 'api::manager.manager'>;
    Name: Schema.Attribute.String & Schema.Attribute.Required;
    NbTerrains: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiDayPlanDayPlan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    busyness: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    >;
    totalSlots: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    week_agendum: Schema.Attribute.Relation<
      'manyToOne',
      'api::week-agenda.week-agenda'
    >;
  };
...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bookedAt: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    statu: Schema.Attribute.Enumeration<['pending', 'confirmed', 'cancelled']>;
    terrain: Schema.Attribute.Relation<'oneToOne', 'api::terrain.terrain'>;
    time_slot: Schema.Attribute.Relation<
      'oneToOne',
      'api::time-slot.time-slot'
    >;
    type: Schema.Attribute.Enumeration<['normal', 'urgent']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTerrainTerrain extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Type: Schema.Attribute.Enumeration<
      ['Football', 'Basketball', 'Paddel', 'Tennis']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_role: Schema.Attribute.Enumeration<['admin', 'manager', 'player']>;
    username: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
